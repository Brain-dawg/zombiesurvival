...
function ENT:Initialize()
	...
	if object:IsValid() then
		...
		object.r,object.g,object.b,object.a = object:GetColor()
		object:SetColor(object.r,object.g,object.b,190)
...
function ENT:Think()
	...
	if object.OriginalMass < CARRY_DRAG_MASS and object:OBBMins():Length() + object:OBBMaxs():Length() < CARRY_DRAG_VOLUME then
		...
		local vel = (targetpos - object:NearestPoint(targetpos)):GetNormal()
		vel.z = 0
		objectphys:ApplyForceCenter(objectphys:GetMass() * frametime * 500 * vel:GetNormal())
	end
...
function ENT:OnRemove()
	...
	local object = self.Object
	if object:IsValid() then
		object:SetColor(object.r,object.g,object.b,object.a)
		local objectphys = object:GetPhysicsObject()
		if objectphys:IsValid() then
		...
		object:SetLocalVelocity ( Vector ( 0,0,0 ) ) 
	end
end
