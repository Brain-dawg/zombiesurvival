...
if ( CLIENT ) then
	SWEP.PrintName = "Bottle o'l Wine"
...
function SWEP:PrimaryAttack()
	...
	self:EmitSound("mrgreen/leeroy.mp3")
...
if CLIENT then
	...
	function SWEP:DrawHUD()
		...
		local tw, th = surface.GetTextSize("Fancy Shitty French Wine")
		local texty = y + hei/2 
		
		 draw.SimpleText("Bottle o'l Wine", "ssNewAmmoFont7", x+space, texty+10, Color(255,255,255,255), TEXT_ALIGN_LEFT)
