...
include("client/vgui/p_intermission_teamscore.lua")
include("client/vgui/p_intermission_nitwits.lua")
include("client/vgui/p_intermission_generalscore.lua")
include("client/vgui/p_intermission_votemap.lua")
